    ...
    useEffect(() => {
        const nodes = [
            ...document.querySelectorAll<HTMLSpanElement>(
                `#${editorID} .language-warp span.token`
            ),
        ];
    ...
    return (
        <div className="bg-white dark:bg-gray-900 border-2 border-gray-100 dark:border-gray-700 rounded-lg overflow-clip">
            <SimpleCodeEditor
                ...
                highlight={(code) => prism.highlight(code, prism.languages.warp, "warp")}
                tabSize={2}
                insertSpaces={false}
                    ...
                    {hover.output.code ? (
                        <div className="pointer-events-none">
                            <SimpleCodeEditor
                                ...
                                highlight={(code) =>
                                    prism.highlight(code, prism.languages.warp, "warp")
                                }
                                onValueChange={() => {}}
