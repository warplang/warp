        ...
        <main>
            ...
            <div className="mx-auto p-6 max-w-4xl">
                <div className="flex items-center justify-between pb-4">
                    ...
                    >
                        <img src="/images/logo.svg" alt="Warp Playground" className="h-10" />
                        <h1 className="font-semibold">Warp Playground</h1>
                    </a>

                    <div className="flex gap-4 text-gray-500 dark:text-gray-400">
                        <a href="?lesson=learn/toc">Learn</a>

                        <a target="_blank" href="https://warp.za16.co/guide">
                            Guide
                        </a>

                        <a target="_blank" href="https://github.com/warplang/warp">
                            GitHub
                        </a>
                    </div>
                </div>
